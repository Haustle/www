...
<IMG url="/dune.png" caption="Shared image from the set of `Dune`"/>
...
<IMG url="/huntergather.png" shadow={false}/>
...
The term above is tossed around by professors and usually you can take it with a grain of salt as sometimes you can finish assignments on minimal time. However, this semester the projects really couldn't be completed in 1-2 day span. Even with a 5-7 day stretch I was quite nervous. As lackadaisical as I've been this year, these large projects really whipped me into shape and helped me learn a ton. My C++ skills have gotten infinitely better after debugging for hours.
